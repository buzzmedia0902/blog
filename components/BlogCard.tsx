...
export function BlogCard({
  ...
  return (
    <Link href={`/blog/${slug}`}>
      <div className="group relative h-full bg-dark-card border border-dark-border rounded-lg p-6 hover:border-accent-purple transition-all duration-300 hover:shadow-lg hover:shadow-accent-purple/20 cursor-pointer">
